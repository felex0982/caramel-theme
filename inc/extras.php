...
if ( ! function_exists( 'understrap_change_logo_class' ) ) {
	...
	function understrap_change_logo_class( $html ) {
		...
		$html = str_replace( 'class="custom-logo-link"', 'class="caramel-logo__img custom-logo-link"', $html );
...
if ( ! function_exists( 'caramel_default_body_attributes' ) ) {
	/**
	 ...
	 * @return array
	 */
	function caramel_default_body_attributes( $atts ) {
		$atts['itemscope'] = '';
		$atts['itemtype']  = 'http://schema.org/WebSite';
		return $atts;
	}
}
add_filter( 'caramel_body_attributes', 'caramel_default_body_attributes' );
