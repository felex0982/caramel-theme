	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'caramel' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'caramel' ); ?></th>
			</tr>
		</thead>
		<tbody>
