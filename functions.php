...
foreach ( $caramel_includes as $file ) {
...
function caramel_set_genre_posts_per_page( $query ) {

	if(is_tax('genre')){
	  $query->set('posts_per_page', -1);
	}
 }
 add_action( 'pre_get_posts', 'caramel_set_genre_posts_per_page' );
