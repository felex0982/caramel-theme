<?php
/**
 * A template partial to output pagination for the caramel default theme.
 *
...
$prev_text = sprintf(
	...
	__( 'Newer <span class="nav-short">Posts</span>', 'caramel' )
);
$next_text = sprintf(
	'<span class="nav-next-text">%s</span> %s',
	__( 'Older <span class="nav-short">Posts</span>', 'caramel' ),
